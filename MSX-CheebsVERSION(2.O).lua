...
local Root = game.Players.LocalPlayer.Character.HumanoidRootPart
local RootTwo = v
if (Root.Position - RootTwo.Position).Magnitude < 10000 then
fireclickdetector(v.ClickDetector)
end end  end end) end end)
...
local Toggle1 = Section1:CreateToggle("Auto ObsidianOreMINE", nil, function(State)
Ore = State
while Ore and wait() do
pcall(function()
for i,v in pairs(game:GetService("Workspace").Ores:GetChildren()) do
if v.Name:lower():match("obsidianore5") and v:FindFirstChild("ClickDetector") then
local Root = game.Players.LocalPlayer.Character.HumanoidRootPart
local RootTwo = v
if (Root.Position - RootTwo.Position).Magnitude < 10000 then
fireclickdetector(v.ClickDetector)
...
local Toggle1 = Section1:CreateToggle("Auto UnobtainiumOre", nil, function(State)
Ore = State
while Ore and wait() do
pcall(function()
for i,v in pairs(game:GetService("Workspace").Ores:GetChildren()) do
if v.Name:lower():match("unobtainiumore6") and v:FindFirstChild("ClickDetector") then
local Root = game.Players.LocalPlayer.Character.HumanoidRootPart
local RootTwo = v
if (Root.Position - RootTwo.Position).Magnitude < 10000 then
fireclickdetector(v.ClickDetector)
...
local Toggle1 = Section1:CreateToggle("Auto UnobtainiumOreMINE", nil, function(State)
Ore = State
while Ore and wait() do
pcall(function()
for i,v in pairs(game:GetService("Workspace").Ores:GetChildren()) do
if v.Name:lower():match("unobtainiumore5") and v:FindFirstChild("ClickDetector") then
local Root = game.Players.LocalPlayer.Character.HumanoidRootPart
local RootTwo = v
if (Root.Position - RootTwo.Position).Magnitude < 10000 then
fireclickdetector(v.ClickDetector)
...
local Toggle1 = Section1:CreateToggle("Auto BedrockOreMINE", nil, function(State)
Ore = State
while Ore and wait() do
pcall(function()
for i,v in pairs(game:GetService("Workspace").Ores:GetChildren()) do
if v.Name:lower():match("bedrockore3") and v:FindFirstChild("ClickDetector") then
local Root = game.Players.LocalPlayer.Character.HumanoidRootPart
local RootTwo = v
if (Root.Position - RootTwo.Position).Magnitude < 10000 then
fireclickdetector(v.ClickDetector)
...
local Toggle1 = Section1:CreateToggle("Auto GemOre Crystal Grind", nil, function(State)
Ore = State
while Ore and wait() do
pcall(function()
for i,v in pairs(game:GetService("Workspace").Ores:GetChildren()) do
if v.Name:lower():match("gemore5") and v:FindFirstChild("ClickDetector") then
local Root = game.Players.LocalPlayer.Character.HumanoidRootPart
local RootTwo = v
if (Root.Position - RootTwo.Position).Magnitude < 10000 then
fireclickdetector(v.ClickDetector)
...
local Toggle1 = Section1:CreateToggle("Auto GiftOre", nil, function(State)
Ore = State
while Ore and wait() do
pcall(function()
for i,v in pairs(game:GetService("Workspace").Ores:GetChildren()) do
if v.Name:lower():match("giftore5") and v:FindFirstChild("ClickDetector") then
local Root = game.Players.LocalPlayer.Character.HumanoidRootPart
local RootTwo = v
if (Root.Position - RootTwo.Position).Magnitude < 10000 then
fireclickdetector(v.ClickDetector)
...
local Toggle1 = Section3:CreateToggle("Auto GoldBonus", nil, function(State)
Bonus = State
...
while Bonus do wait() 
game:GetService("ReplicatedStorage").GiveBonus:FireServer(unpack(args))

end end)

local Toggle1 = Section3:CreateToggle("Auto GemBonus", nil, function(State)
Bonus = State
...
local Toggle1 = Section3:CreateToggle("Auto CrystalBonus", nil, function(State)
Bonus = State
...
local Toggle1 = Section3:CreateToggle("Auto Buy1 Unreal Rune", nil, function(State)
rune = State

while rune do wait() 
game:GetService("ReplicatedStorage").BuyRune5:FireServer(1)
end end)

local Toggle1 = Section3:CreateToggle("Auto Buy10 Unreal Rune", nil, function(State)
rune = State

while rune do wait() 
game:GetService("ReplicatedStorage").BuyRune5:FireServer(10)
end end)

local Toggle1 = Section3:CreateToggle("Auto Buy100 Unreal Rune", nil, function(State)
rune = State

while rune do wait() 
game:GetService("ReplicatedStorage").BuyRune5:FireServer(100)
end end)

local Toggle1 = Section3:CreateToggle("Auto Buy1000 Unreal Rune", nil, function(State)
rune = State

while rune do wait() 
game:GetService("ReplicatedStorage").BuyRune5:FireServer(1000)
end end)

local Toggle1 = Section3:CreateToggle("Auto Buy10000 Unreal Rune", nil, function(State)
rune = State

while rune do wait() 
game:GetService("ReplicatedStorage").BuyRune5:FireServer(10000)
end end)
...
Section4:CreateLabel("Credits ! ! Cheebs_The_Serious_Doggo ! !#9254")
Section4:CreateLabel("Credits AlexR32#3232 Ui")
Section4:CreateLabel("Credits MATY")
