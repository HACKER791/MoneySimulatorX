...
pcall(function()
for i,v in pairs(game:GetService("Workspace").Ores:GetChildren()) do
if v.Name:lower():match("obsidianore6", "obsidianore5") and v:FindFirstChild("ClickDetector") then
local Root = game.Players.LocalPlayer.Character.HumanoidRootPart
local RootTwo = v
if (Root.Position - RootTwo.Position).Magnitude < 100000 then
fireclickdetector(v.ClickDetector)
...
pcall(function()
for i,v in pairs(game:GetService("Workspace").Ores:GetChildren()) do
if v.Name:lower():match("unobtaniumore5", "unobtaniumore6") and v:FindFirstChild("ClickDetector") then
local Root = game.Players.LocalPlayer.Character.HumanoidRootPart
local RootTwo = v
if (Root.Position - RootTwo.Position).Magnitude < 100000 then
fireclickdetector(v.ClickDetector)
