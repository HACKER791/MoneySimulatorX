...
local Toggle1 = Section1:CreateToggle("Auto UnobtaniumOreMINE", nil, function(State)
Ore = State
while Ore and wait() do
pcall(function()
for i,v in pairs(game:GetService("Workspace").Ores:GetChildren()) do
...
local Toggle1 = Section1:CreateToggle("Auto GoldBonus", nil, function(state)
Bonus = State
...
while Bonus and wait() do
game:GetService("ReplicatedStorage").GiveBonus:FireServer(unpack(args1))

end end)

local Toggle1 = Section1:CreateToggle("Auto GemBonus", nil, function(state)
Bonus = State
...
while Bonus and wait() do
game:GetService("ReplicatedStorage").GiveBonus:FireServer(unpack(args2))

end end)

local Toggle1 = Section1:CreateToggle("Auto CrystalBonus", nil, function(state)
Bonus = State
...
while Bonus and wait() do
game:GetService("ReplicatedStorage").GiveBonus:FireServer(unpack(args3))
...
Section3:CreateLabel("Credits ! ! Cheebs_The_Serious_Doggo ! !#9254")
Section3:CreateLabel("Credits AlexR32#3232 Ui")
Section3:CreateLabel("Credits MATY")
